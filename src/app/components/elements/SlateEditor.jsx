...
export default class SlateEditor extends React.Component {
  ...
  onClickLink = (e) => {
    ...
    if (hasLinks) {
      ...
      const href = window.prompt('Enter the URL of the link:', 'https://wls.fintehru.org')
      if (href) {
        state = state
          .transform()
          .wrapInline({
  ...
  renderMarkButton = (props) => {
    ...
    return (
      <span key={type} className={'SlateEditor__menu-button SlateEditor__menu-button-' + type} onMouseDown={onMouseDown}
