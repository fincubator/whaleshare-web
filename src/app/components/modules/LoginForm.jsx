  ...
  render() {
    ...
    const form = (
      ...
      >
        ...
        <div>
          <input type="password" required ref="pw" placeholder={tt('loginform_jsx.password_or_wif')} {...password.props}
                 autoComplete="on" disabled={submitting}/>
        ...
        <div>
          <label className="LoginForm__save-login" htmlFor="saveLogin">
            ...
            <input id="saveLogin" type="checkbox" ref="pw" {...saveLogin.props} onChange={this.saveLoginToggle}
        ...
        <div className="login-modal-buttons">
          ...
          {this.props.onCancel &&
          <button type="button float-right" disabled={submitting} className="button hollow" onClick={onCancel}>
            {tt('g.cancel')}
          </button>}
        </div>
        <div className="sign-up">
          ...
          <a href="/claim.html">{tt('g.claim_acc')}</a>
        </div>
      </form>
    );
