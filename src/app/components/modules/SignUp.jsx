  ...
  render() {
    ...
    return <div className="SignUp">
      <div className="row">
        <div className="column">
          <h3>Sign Up</h3>
          <p>Whaleshares funds each account with over {this.props.signup_bonus} worth of Steem Power; to prevent abuse,
            we
      ...
      <div className="row">
        <div className="column">
          <br/>
          <p className="secondary">By verifying your account you agree to the Whaleshares <a href="/tos.html"
