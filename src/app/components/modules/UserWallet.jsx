    ...
    return (<div className="UserWallet">
      ...
      <div className="UserWallet__balance row zebra">
        ...
        <div className="column small-12 medium-4">
          {isMyAccount ?
            <FoundationDropdownMenu className="Wallet_dropdown" dropdownPosition="bottom" dropdownAlignment="right"
                                    label={power_balance_str + ' WHALESTAKE'} menu={power_menu}/>
      ...
      <div className="UserWallet__balance row">
        ...
        <div className="column small-12 medium-4">
          {isMyAccount ?
            <FoundationDropdownMenu className="Wallet_dropdown" dropdownPosition="bottom" dropdownAlignment="right"
                                    label={steem_balance_str + ' WLS'} menu={steem_menu}/>
