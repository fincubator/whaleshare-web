...
const DISABLED_SIGNING_KEY = 'WLS1111111111111111111111111111111114T1Anm';
              ...
              <form>
                <div className="input-group">
                  ...
                  <input className="input-group-field" type="text"
                         style={{float: "left", width: "75%", maxWidth: "20rem"}} value={customUsername}
                ...
                <form>
                  <div className="input-group">
                    <input className="input-group-field bold" disabled type="text"
                           style={{float: "left", width: "75%", maxWidth: "20rem"}} value={current_proxy}/>
                    <div className="input-group-button">
              ...
              <form>
                <div className="input-group">
                  ...
                  <input className="input-group-field bold" type="text"
                         style={{float: "left", width: "75%", maxWidth: "20rem"}} value={proxy} onChange={(e) => {
