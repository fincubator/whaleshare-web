        ...
        <div className="column">
          ...
          <div className="callout alert">
            ...
            <p>The latest versions of <a href="https://www.google.com/chrome/">Chrome</a> and <a
              ...
              are well tested and known to work.</p>
          </div>
        </div>
      </div>;
    }
          ...
          <div className="column">
            ...
            {showRules ? <div className="CreateAccount__rules">
              <p>
                ...
                The third rule of Whaleshares is: We cannot recover your password, or your account if you lose your
                password.<br/>
            ...
            <form onSubmit={this.onSubmit} autoComplete="off" noValidate method="post">
              ...
              { // TODO: remove this after May 20th
                this.state.account_has_keys_warning && <div className="warning">
                  Please note: due to recent security changes if you chosen a password before during signup, this one
                  below will override it — this is the one you need to save.
                </div>
              }
