 ...
 *    - basic sanitization?
 *  2. Whaleshares Rendering - add in proprietary functions/links
 ...
 */
export default function (html, {mutate = true, hideImages = false, enable_proxify_images=true} = {}) {
  const state = {mutate}
  ...
  try {
    ...
    if (mutate) {
      if (hideImages) {
        ...
        proxifyImages(doc, enable_proxify_images)
      }
    }
